...
import 'package:tourmate1/updateParkTable.dart';
import 'package:tourmate1/updateParkTable.dart';
import 'package:tourmate1/updateRestaurantTable.dart';
...
class RestaurantDataCustomization extends StatefulWidget {
  ...
  @override
  State<RestaurantDataCustomization> createState() => _RestaurantDataCustomizationState();
}

class _RestaurantDataCustomizationState extends State<RestaurantDataCustomization> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("Resturents").snapshots(),
